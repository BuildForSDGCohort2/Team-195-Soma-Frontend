...
export default class Category extends Component {
  ...
  getData() {
    axios
      .get("https://team-195-soma-backend.herokuapp.com/api/admin")
      .then((res) => {
  ...
  onSubmit(e) {
    ...
    axios
      .post(
        "https://team-195-soma-backend.herokuapp.com/api/man/category",
        this.state.form
      )
      .then(({ data }) => {
  ...
  showForm(e) {
    ...
    document.getElementById("fillForm").style.display = this.state.formState
      ? "block"
      : "none";
      ...
      <div>
        ...
        <div id="fillForm" className="fill-parent" style={{ display: "none" }}>
          <div className="fill-form">
            <button type="button" onClick={this.showForm} className="close">
              &times;
            </button>
